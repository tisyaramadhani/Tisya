...
const presidentSpeech = React.lazy(
  () => import('./views/appearsMenu/appearsAbout/appearsPresident/presidentSpeech'),
)
...
const About = React.lazy(() => import('./views/appearsMenu/appearsAbout/appearsProfile/About'))
...
const routes =
  roles_id === 2
    ? [
        ...
        { path: '/candidatesData', name: 'Candidate Data', element: viewCandidates },
        { path: '/interviewerAccess', name: 'Candidate Data', element: intervAccessPage },
      ]
    : [
        ...
        { path: '/applicationMenu/Vacancy', name: 'Vacancy', element: vacancyPage },
        {
          path: '/applicationMenu/adminPass',
          name: 'Candidate Pass',
          element: passAdministration,
        },
        { path: '/applicationMenu/adminNotPass', name: 'Candidate Fail', element: notPass },
        { path: '/interviewer', name: 'Interviewer', element: interviewerPage },
        { path: '/user', name: 'User', element: userPage },
        { path: '/appearsMenu', name: 'View', element: Home, exact: true },
        { path: '/appearsMenu/appearsHome', name: 'Home', element: Home },
        { path: '/appearsMenu/appearsAbout', name: 'About', element: About, exact: true },
        { path: '/appearsMenu/educationMaster', name: 'Education Master', element: educationM },
        { path: '/appearsMenu/majorMaster', name: 'Major Master', element: majorM },
        { path: '/appearsMenu/expertiseMaster', name: 'Expertise Master', element: expertiseM },
        {
        ...
        {
          path: '/appearsMenu/appearsAbout/appearsProfile',
          name: 'Company Profile',
          element: About,
        },
        {
          path: '/appearsMenu/appearsAbout/appearsPresident',
          name: 'President Director',
          element: presidentSpeech,
        },
        { path: '/selectionMaster', name: 'Selection Master', element: selectionM },
        { path: '/sectionMaster', name: 'Section Master', element: sectionM },
        { path: '/vacancyDetail', name: 'Vacancy Detail', element: detailVacancy },
        { path: '/applicantData', name: 'Applicant Data', element: dataApplicant },
        { path: '/candidatesResult', name: 'Candidate Result', element: resultCandidates },
        { path: '/candidateAtten', name: 'Attendance', element: resultAtten },
